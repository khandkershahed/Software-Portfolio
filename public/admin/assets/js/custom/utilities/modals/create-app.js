    ...
    init: function() {
      (e = document.querySelector("#kt_modal_create_app")) &&
        (
          ...
          i.on("kt.stepper.next", function(e) {
            ...
            t
              ? t.validate().then(function(t) {
                  console.log(
                    "validated!"
                  ), "Valid" == t ? e.goNext() : Swal.fire({ text: "Sorry, looks like there are some errors detected, please try again.", icon: "error", buttonsStyling: !1, confirmButtonText: "Ok, got it!", customClass: { confirmButton: "btn btn-light" } }).then(function() {});
                })
          ...
          $(
            o.querySelector('[name="card_expiry_month"]')
          ).on("change", function() {
          ...
          n.push(
            FormValidation.formValidation(o, {
              fields: {
                name: {
                  validators: { notEmpty: { message: "App name is required" } }
                },
                category: {
          ...
          n.push(
            FormValidation.formValidation(o, {
              fields: {
                framework: {
                  validators: { notEmpty: { message: "Framework is required" } }
                }
              },
              plugins: {
                trigger: new FormValidation.plugins.Trigger(),
          ...
          n.push(
            FormValidation.formValidation(o, {
              fields: {
                ...
                dbengine: {
                  validators: {
                    notEmpty: { message: "Database engine is required" }
                  }
                }
              },
              plugins: {
