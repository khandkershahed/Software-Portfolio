...
<div class="shape-container" id="section1">
    <!-- Feature Section Start -->
    @if (!empty(optional($categoryOne)->name) || !empty(optional($categoryOne)->description))
    <section>
        <div class="container py-0 py-lg-5">
            <div class="row align-items-center">
                <div class="col-lg-6">
    ...
    <!-- Feature Section Start -->
    @if (!empty(optional($categoryTwo)->name) || !empty(optional($categoryTwo)->description))
    <section>
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div>
                        <div class="d-flex align-items-center">
                            ...
                            <span class="line-white ms-2"></span>
                        </div>
                        <p class="pt-3 grp-para">
