<x-admin-app-layout :title="'Term & Condition Edit'">
    <div class="card card-flash">
        ...
        <div class="card-body">
            <form id="myForm" method="post" action="{{ route('admin.privacy.update', $item->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" class="form-control" 
                                    value="{{ old('title', $item->title) }}" placeholder="Enter name">
                            </div>
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="version" id="version" class="form-control" 
                                    value="{{ old('version', $item->version) }}" placeholder="Enter version">
                            </div>
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <input type="date" name="effective_date" id="effective_date" class="form-control" 
                                    value="{{ old('effective_date', $item->effective_date) }}">
                            </div>
                        </div>
