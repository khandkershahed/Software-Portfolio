<x-admin-app-layout :title="'Privacy And Policy'">
    ...
    <div class="card card-flash">
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                <a href="{{ route('admin.privacy.create') }}" class="btn btn-light-primary rounded-2">
                ...
                <tbody class="fw-bold text-gray-600">
                    @foreach ($items as $key => $item)
                        <tr>
                            ...
                            <td class="text-start">
                                ...
                                <label class="switch">
                                    <input type="checkbox" class="status-toggle" data-id="{{ $item->id }}"
                                        ...
                                        data-url="{{ route('admin.privacy.toggle-status', $item->id) }}">
                            ...
                            <td>
                                <a href="{{ route('admin.privacy.edit', $item->id) }}" class="text-primary">
                                    <i class="fa fa-edit text-primary fs-4"></i>
                                </a>
                                <a href="{{ route('admin.privacy.destroy', $item->id) }}" class="delete">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.status-toggle').change(function() {
                    var status = $(this).prop('checked') ? 'active' : 'inactive'; // Deprivacyine new status
