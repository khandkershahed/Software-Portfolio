<x-admin-app-layout :title="'Company Data Edit'">
    ...
    <div class="card card-flash">
        ...
        <div class="card-body">
            ...
            <form id="myForm" method="post" action="{{ route('admin.company-data.update', $item->id) }}"
                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <div id="statusError" class="invalid-feedback" style="display: none;">Please select a status</div>
                            </div>
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="icon" placeholder="Company Icon"
                                    class="form-control form-control-sm" value="{{ old('icon',$item->icon) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="link" placeholder="Company Link"
                                    class="form-control form-control-sm" value="{{ old('link',$item->link) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="data" placeholder="Company Data"
                                    class="form-control form-control-sm" value="{{ old('data',$item->data) }}">
                            </div>
                        </div>

                        <div class="col-12 mb-3 mt-4">
                            <button type="submit" class="btn btn-dark rounded-0 px-5 btn-sm float-end">Update Data</button>
                        </div>
