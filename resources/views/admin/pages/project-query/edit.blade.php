<x-admin-app-layout :title="'Project Query Edit'">
    ...
    <div class="card card-flash">
        ...
        <div class="card-body">
            ...
            <form id="myForm" method="post" action="{{ route('admin.project-query.update', $item->id) }}"
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="email" placeholder="Enter your email"
                                    class="form-control form-control-sm" value="{{ old('email', $item->email) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" id="phone" placeholder="Enter your phone"
                                    class="form-control form-control-sm" value="{{ old('phone', $item->phone) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="message" id="message" rows="4" placeholder="Your message"
                                    class="form-control form-control-sm editor">{{ old('message', $item->message) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="complete_template" id="complete_template"
                                    ...
                                    {{ old('complete_template', $item->complete_template) ? 'checked' : '' }}>
                            </div>
                        </div>
