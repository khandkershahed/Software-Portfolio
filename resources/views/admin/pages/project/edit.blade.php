<x-admin-app-layout :title="'Project Edit'">
    ...
    <div class="card card-flash">
        ...
        <div class="card-body">
            ...
            <form id="myForm" method="post" action="{{ route('admin.project.update', $item->id) }}"
                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="live_link" placeholder="Project Live Link"
                                    ...
                                    value="{{ old('live_link', $item->live_link) }}">
                            </div>
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="facebook_link" id="facebook_link"
                                    placeholder="Facebook Link" class="form-control form-control-sm"
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="linkedin_link" id="linkedin_link"
                                    placeholder="LinkedIn Link" class="form-control form-control-sm"
                                    value="{{ old('linkedin_link', $item->linkedin_link ?? '') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="team" id="team" placeholder="Team Members"
                                    class="form-control form-control-sm"
                                    value="{{ old('team', $item->team ?? '') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <img src="{{ !empty($item->logo) ? url('storage/' . $item->logo) : 'https://ui-avatars.com/api/?name=' . urlencode($item->name) }}"
                                    style="width: 60px;height: 40px;" class="mt-2" alt="">
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <img src="{{ !empty($item->image_three) ? url('storage/' . $item->image_three) : 'https://ui-avatars.com/api/?name=' . urlencode($item->name) }}"
                                    style="width: 60px;height: 40px;" class="mt-2" alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            ...
                            <input type="text" name="row_one_badge" id="row_one_badge"
                                placeholder="Row One Badge" class="form-control form-control-sm"
                        ...
                        <div class="col-3 mb-3">
                            ...
                            <input type="text" name="row_one_title" id="row_one_title"
                                placeholder="Row One Title" class="form-control form-control-sm"
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <img src="{{ !empty($item->row_one_image) ? url('storage/' . $item->row_one_image) : 'https://ui-avatars.com/api/?name=' . urlencode($item->name) }}"
                                    style="width: 60px;height: 40px;" class="mt-2" alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="row_one_description" id="row_one_description" class="form-control form-control-sm editor"
                                placeholder="Row One Description">{{ old('row_one_description', $item->row_one_description ?? '') }}</textarea>
                        </div>

                        <div class="col-3 mb-3">
                            <label for="row_one_button_name" class="mb-2">Row One Button Name</label>
                            <input type="text" name="row_one_button_name" id="row_one_button_name"
                                placeholder="Row One Button Name" class="form-control form-control-sm"
                                value="{{ old('row_one_button_name', $item->row_one_button_name ?? '') }}">
                        </div>

                        <div class="col-3 mb-3">
                            <label for="row_one_button_link" class="mb-2">Row One Button Link</label>
                            <input type="text" name="row_one_button_link" id="row_one_button_link"
                                placeholder="Row One Button Link" class="form-control form-control-sm"
                        ...
                        <div class="col-3 mb-3">
                            ...
                            <input type="text" name="row_two_badge" id="row_two_badge"
                                placeholder="Row Two Badge" class="form-control form-control-sm"
                                value="{{ old('row_two_badge', $item->row_two_badge ?? '') }}">
                        </div>

                        <div class="col-3 mb-3">
                            <label for="row_two_title" class="mb-2">Row Two Title</label>
                            <input type="text" name="row_two_title" id="row_two_title"
                                placeholder="Row Two Title" class="form-control form-control-sm"
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <img src="{{ !empty($item->row_two_image) ? url('storage/' . $item->row_two_image) : 'https://ui-avatars.com/api/?name=' . urlencode($item->name) }}"
                                    style="width: 60px;height: 40px;" class="mt-2" alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="row_two_description" class="form-control form-control-sm editor" placeholder="Row Two Description">{{ old('row_two_description', $item->row_two_description ?? '') }}</textarea>
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            ...
                            <input type="text" name="row_two_button_name" placeholder="Row Two Button Name"
                                class="form-control form-control-sm"
                                value="{{ old('row_two_button_name', $item->row_two_button_name ?? '') }}">
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            ...
                            <input type="text" name="row_two_button_link" placeholder="Row Two Button Link"
                                class="form-control form-control-sm"
                                value="{{ old('row_two_button_link', $item->row_two_button_link ?? '') }}">
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            ...
                            <input type="text" name="row_two_image_title" placeholder="Row Two Image Title"
                                class="form-control form-control-sm"
                                value="{{ old('row_two_image_title', $item->row_two_image_title ?? '') }}">
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="row_two_image_description" class="form-control form-control-sm editor"
                                placeholder="Row Two Image Description">{{ old('row_two_image_description', $item->row_two_image_description ?? '') }}</textarea>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="row_three_description" class="form-control form-control-sm editor"
                                placeholder="Row Three Description">{{ old('row_three_description', $item->row_three_description ?? '') }}</textarea>
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            ...
                            <input type="text" name="gallery_title" placeholder="Gallery Title"
                                class="form-control form-control-sm"
                                value="{{ old('gallery_title', $item->gallery_title ?? '') }}">
                        </div>

                        <div class="col-12 mb-3">
                            <label for="gallery_description" class="mb-2">Gallery Description</label>
                            <textarea name="gallery_description" class="form-control form-control-sm editor" placeholder="Gallery Description">{{ old('gallery_description', $item->gallery_description ?? '') }}</textarea>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="row_four_description" class="form-control form-control-sm editor" placeholder="Row Four Description">{{ old('row_four_description', $item->row_four_description ?? '') }}</textarea>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea name="row_five_description" class="form-control form-control-sm editor" placeholder="Row Five Description">{{ old('row_five_description', $item->row_five_description ?? '') }}</textarea>
                        </div>
