    ...
    <div class="card-body pt-9 pb-0">
                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <a href="#"
                                class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{ $profileData->name }}</a>
                            <a href="#">
                            ...
                            @foreach ($profileData->roles as $role)
                                <span
                                    class="btn btn-sm btn-light-danger fw-bolder ms-2 fs-8 py-1 px-3">{{ $role->name }}</span>
                            @endforeach
                        ...
                        <div class="d-flex flex-wrap fw-bold fs-6 mb-4 pe-2">
                            <a href="#"
                                ...
                                <!--end::Svg Icon-->{{ $profileData->phone }}</a>
                            <a href="#"
                                class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                ...
                                <!--end::Svg Icon-->{{ $profileData->address }}</a>
                            <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary mb-2">
                                ...
                                <!--end::Svg Icon-->{{ $profileData->email }}</a>
                        </div>
                        <!--end::Info-->
                    </div>
                    <!--end::User-->
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
            ...
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ $routes == 'admin.profile' ? 'active' : '' }}"
