<x-admin-app-layout :title="'Details of ' . $employee->name">
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-center flex-column py-5">
                        ...
                        <a href="#"
                            class="fs-3 text-gray-800 text-hover-primary fw-bolder mb-3">{{ $employee->name }}</a>
                    ...
                    <div class="d-flex flex-stack fs-4 py-3">
                        <div class="fw-bolder rotate collapsible" data-bs-toggle="collapse"
                            data-bs-target="#employee_collapse_details_{{ $employee->id }}" role="button"
                            aria-expanded="false" aria-controls="employee_collapse_details_{{ $employee->id }}">
                            Details
                    ...
                    <div class="collapse show" id="employee_collapse_details_{{ $employee->id }}">
                        <div class="pb-5 fs-6">
        ...
        <div class="flex-lg-row-fluid ms-lg-15">
            ...
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
                ...
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab"
                        href="#kt_employee_view_overview_tab">Overview</a>
                </li>


                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4" data-kt-countup-tabs="true" data-bs-toggle="tab"
                        href="#kt_employee_view_overview_security">Security</a>
                </li>


                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                        href="#kt_employee_view_overview_events_and_logs_tab">Events &amp; Logs</a>
                </li>
                ...
                <li class="nav-item ms-auto">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-250px fs-6"
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="{{ route('admin.employee.edit', $employee->id) }}" class="menu-link px-5">Account
                                Settings</a>
                        </div>
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ route('admin.employee.destroy', $employee->id) }}"
                                class="menu-link text-danger px-5 delete">Delete This employee</a>
                        </div>
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="kt_employee_view_overview_tab" role="tabpanel">
                    @include('admin.pages.employee.partials.overview')
                </div>


                <div class="tab-pane fade" id="kt_employee_view_overview_security" role="tabpanel">

                    @include('admin.pages.employee.partials.security')

                </div>


                <div class="tab-pane fade" id="kt_employee_view_overview_events_and_logs_tab" role="tabpanel">

                    @include('admin.pages.employee.partials.activity-logs')
    ...
    <div class="modal fade metronic_modal" id="update_email_{{ $employee->id }}" tabindex="-1">
    ...
    <div class="modal fade metronic_modal" id="update_password_{{ $employee->id }}" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">

                    <h2 class="fw-bolder">Update employee Password</h2>
    ...
    <div class="modal fade metronic_modal" id="update_role_{{ $employee->id }}" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                <div class="modal-header">

                    <h2 class="fw-bolder">Update employee Role</h2>
                    ...
                    <form class="form" method="POST" action="{{ route('admin.employee.update', $employee->id) }}">
                        ...
                        <div
                            ...
                            <div class="d-flex flex-stack flex-grow-1">
                                ...
                                <div class="fw-bold">
                                    <div class="fs-6 text-gray-700">Please note that reducing a employee role rank, that
                                        employee will lose all priviledges that was assigned to the previous role.</div>
                                </div>
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <label class="fs-6 fw-bold form-label mb-5">
                                <span class="required">Select a employee role</span>
                            </label>
                    ...
                    <form class="form" id="kt_modal_add_one_time_password_form">
                        ...
                        <div class="text-center pt-15">
                            <button type="reset" class="btn btn-light me-3"
                                data-kt-employees-modal-action="cancel">Cancel</button>
