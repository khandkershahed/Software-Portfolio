            ...
            <form id="myForm" method="post" action="{{ route('admin.about.store') }}" enctype="multipart/form-data">
                ...
                <div class="card bg-secondary rounded-0 p-5">
                    <div class="row p-4">
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                <label for="row_one_badge" class="mb-2">Row One Title</label>
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <img id="rowOneImageBigPreview" src="" alt="Image Preview"
                                    class="img-thumbnail mt-2" style="display:none; width: 70px; height: 70px;">
                            </div>
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <img id="rowOneImageSmallPreview" src="" alt="Image Preview"
                                    class="img-thumbnail mt-2" style="display:none; width: 70px; height: 70px;">
                            </div>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="row_one_description" class="form-control editor" rows="3">{{ old('row_one_description') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <input type="url" name="row_one_button_url" placeholder="Button URL"
                                    class="form-control form-control-sm" value="{{ old('row_one_button_url') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                <label for="row_three_badge" class="mb-2">Row Three Title</label>
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <img id="rowThreeImageBigPreview" src="" alt="Image Preview"
                                    class="img-thumbnail mt-2" style="display:none; width: 70px; height: 70px;">
                            </div>
                        </div>
                        ...
                        <div class="col-3 mb-3">
                            <div class="form-group">
                                ...
                                <img id="rowThreeImageSmallPreview" src="" alt="Image Preview"
                                    class="img-thumbnail mt-2" style="display:none; width: 70px; height: 70px;">
                            </div>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="row_three_description" class="form-control editor" rows="3">{{ old('row_three_description') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="url" name="row_three_button_url" placeholder="Button URL"
                                    class="form-control form-control-sm" value="{{ old('row_three_button_url') }}">
                            </div>
                        </div>
