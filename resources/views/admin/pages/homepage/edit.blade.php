<x-admin-app-layout :title="'HomePage Edit'">
    <div class="card card-flash">
        ...
        <div class="card-body">
            ...
            <form id="myForm" method="POST" action="{{ route('admin.homepage.update', $item->id) }}"
                ...
                <div class="card bg-secondary rounded-0 p-5">
                    <div class="row p-4">
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="row_one_badge" id="row_one_badge"
                                    ...
                                    value="{{ old('row_one_badge', $item->row_one_badge) }}" placeholder="Enter Badge">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="row_one_title" id="row_one_title"
                                    class="form-control form-control-sm"
                                    value="{{ old('row_one_title', $item->row_one_title) }}" placeholder="Enter Title">
                            </div>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="row_one_link" id="row_one_link"
                                    class="form-control form-control-sm"
                                    value="{{ old('row_one_link', $item->row_one_link) }}" placeholder="Enter Link">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="form-group">
                                <label for="row_two_icon_one" class="mb-2">Row Two Icon One</label>
                                <input type="text" name="row_two_icon_one" id="row_two_icon_one"
                                    class="form-control form-control-sm"
                                    value="{{ old('row_two_icon_one', $item->row_two_icon_one) }}" placeholder="">
                            </div>
                        </div>

                        <div class="col-md-3 mb-3">
                            <div class="form-group">
                                <label for="row_two_icon_one_title" class="mb-2">Row Two Icon One Title</label>
                                <input type="text" name="row_two_icon_one_title" id="row_two_icon_one_title"
                                    class="form-control form-control-sm"
                                    value="{{ old('row_two_icon_one_title', $item->row_two_icon_one_title) }}"
                                    placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="form-group">
                                <label for="row_two_icon_two" class="mb-2">Row Two Icon Two</label>
                                <input type="text" name="row_two_icon_two" id="row_two_icon_two"
                                    class="form-control form-control-sm"
                                    value="{{ old('row_two_icon_two', $item->row_two_icon_two) }}" placeholder="">
                            </div>
                        </div>

                        <div class="col-md-3 mb-3">
                            <div class="form-group">
                                <label for="row_two_icon_two_title" class="mb-2">Row Two Icon Two Title</label>
                                <input type="text" name="row_two_icon_two_title" id="row_two_icon_two_title"
                                    class="form-control form-control-sm"
                                    value="{{ old('row_two_icon_two_title', $item->row_two_icon_two_title) }}"
                                    placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="form-group">
                                <label for="row_two_icon_three" class="mb-2">Row Two Icon Three</label>
                                <input type="text" name="row_two_icon_three" id="row_two_icon_three"
                                    class="form-control form-control-sm"
                                    value="{{ old('row_two_icon_three', $item->row_two_icon_three) }}"
                                    placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="form-group">
                                <label for="row_two_icon_three_title" class="mb-2">Row Two Icon Three Title</label>
                                <input type="text" name="row_two_icon_three_title" id="row_two_icon_three_title"
                                    class="form-control form-control-sm"
                                    value="{{ old('row_two_icon_three_title', $item->row_two_icon_three_title) }}"
                                    placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="form-group">
                                <label for="row_two_icon_four" class="mb-2">Row Two Icon Four</label>
                                <input type="text" name="row_two_icon_four" id="row_two_icon_four"
                                    class="form-control form-control-sm"
                                    value="{{ old('row_two_icon_four', $item->row_two_icon_four) }}" placeholder="">
                            </div>
                        </div>

                        <div class="col-md-3 mb-3">
                            <div class="form-group">
                                <label for="row_two_icon_four_title" class="mb-2">Row Two Icon Four Title</label>
                                <input type="text" name="row_two_icon_four_title" id="row_two_icon_four_title"
                                    class="form-control form-control-sm"
                                    value="{{ old('row_two_icon_four_title', $item->row_two_icon_four_title) }}"
                                    placeholder="">
                            </div>
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="row_four_description" id="row_four_description" class="form-control form-control-sm"
                                    placeholder="Enter Description">{{ old('row_four_description', $item->row_four_description) }}</textarea>
                            </div>
                        </div>
