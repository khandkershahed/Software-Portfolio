<x-admin-app-layout :title="'Page Banner'">
                ...
                <tbody class="fw-bold text-gray-600">
                    @foreach ($items as $key => $item)
                        <tr>
                            ...
                            <td class="text-start">{{ $item->badge }}</td>
                            <td class="text-start">{{ $item->title }}</td>
                            <td class="text-start">{{ $item->button_name }}</td>
                            <td class="text-start">{{ $item->button_link }}</td>
                            ...
                            <td class="text-start">
                                ...
                                <label class="switch">
                                    <input type="checkbox" class="status-toggle" data-id="{{ $item->id }}"
                                        ...
                                        data-url="{{ route('admin.page-banner.toggle-status', $item->id) }}">
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.page-banner.destroy', $item->id) }}" class="delete">
