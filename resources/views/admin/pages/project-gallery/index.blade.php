<x-admin-app-layout :title="'Project Gallery'">
    ...
    <div class="card card-flash">
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                <a href="{{ route('admin.project-gallery.create') }}" class="btn btn-light-primary rounded-2">
                ...
                <tbody class="fw-bold text-gray-600">
                    @foreach ($items as $key => $item)
                        <tr>
                            ...
                            <td class="text-start" style="color: {{ $item->status == 'active' ? 'green' : 'red' }};">
                                {{ $item->status }}
                            </td>

                            <td>
                                <a href="{{ route('admin.project-gallery.edit', $item->id) }}" class="text-primary">
                                    <i class="fa fa-edit text-primary fs-4"></i>
                                </a>
                                <a href="{{ route('admin.project-gallery.destroy', $item->id) }}" class="delete">
