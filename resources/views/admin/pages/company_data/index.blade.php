    ...
    <div class="card card-flash">
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                <a href="{{ route('admin.company-data.create') }}" class="btn btn-light-primary rounded-2">
                ...
                <tbody class="fw-bold text-gray-600">
                    @foreach ($items as $key => $item)
                        <tr>
                            ...
                            <td class="text-start">{{ $item->link }}</td>
                            <td class="text-start">{{ $item->data }}</td>
                            ...
                            <td class="text-start">
                                ...
                                <label class="switch">
                                    <input type="checkbox" class="status-toggle" data-id="{{ $item->id }}"
                                        ...
                                        data-url="{{ route('admin.company-data.toggle-status', $item->id) }}">
                            ...
                            <td>
                                <a href="{{ route('admin.company-data.edit', $item->id) }}" class="text-primary">
                                    <i class="fa fa-edit text-primary fs-4"></i>
                                </a>
                                <a href="{{ route('admin.company-data.destroy', $item->id) }}" class="delete">
