<x-admin-app-layout :title="'Term & Condition'">
    ...
    <div class="card card-flash">
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                <a href="{{ route('admin.term.create') }}" class="btn btn-light-primary rounded-2">
                ...
                <tbody class="fw-bold text-gray-600">
                    @foreach ($items as $key => $item)
                        <tr>
                            ...
                            <td class="text-start">
                                ...
                                <label class="switch">
                                    <input type="checkbox" class="status-toggle" data-id="{{ $item->id }}"
                                        ...
                                        data-url="{{ route('admin.term.toggle-status', $item->id) }}">
                            ...
                            <td>
                                <a href="{{ route('admin.term.edit', $item->id) }}" class="text-primary">
                                    <i class="fa fa-edit text-primary fs-4"></i>
                                </a>
                                <a href="{{ route('admin.term.destroy', $item->id) }}" class="delete">
