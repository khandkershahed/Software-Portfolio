                            ...
                            <div class="card-body">
                                <div class="py-5 text-center">
                                    <img width="200px" class="img-fluid"
                                        src="{{ !empty($site->site_logo_white) && file_exists(public_path('storage/settings/' . $site->site_logo_white)) ? asset('storage/settings/' . $site->site_logo_white) : 'https://www.ngenitltd.com/storage/RZlRwzfUA8get0PcCzQphbeIJu6OhSL7ltNc4xiZ.png' }}"
                                        alt="">
                                </div>
